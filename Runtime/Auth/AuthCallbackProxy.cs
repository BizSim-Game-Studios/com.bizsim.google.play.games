...
namespace BizSim.Google.Play.Games
{
    ...
    /// Requires ProGuard keep rules for com.bizsim.google.play.games.callbacks.IAuthCallback.
    /// </summary>
    internal class AuthCallbackProxy : AndroidJavaProxy
    {
        ...
        /// Interface name MUST match Java: "com.bizsim.google.play.games.callbacks.IAuthCallback"
        /// </summary>
