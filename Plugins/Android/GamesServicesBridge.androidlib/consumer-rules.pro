# Consumer ProGuard/R8 rules for com.bizsim.google.play.games
...
-keep class com.bizsim.google.play.games.** { *; }
-keepclassmembers class com.bizsim.google.play.games.** { *; }
-keep class com.bizsim.google.play.games.**$* { *; }

# Callback Interfaces (CRITICAL for AndroidJavaProxy — method name matching)
-keep interface com.bizsim.google.play.games.callbacks.** { *; }

-keepclassmembers interface com.bizsim.google.play.games.callbacks.IAuthCallback {
...
-keepclassmembers interface com.bizsim.google.play.games.achievements.IAchievementCallback {
...
-keepclassmembers interface com.bizsim.google.play.games.leaderboards.ILeaderboardCallback {
...
-keepclassmembers interface com.bizsim.google.play.games.stats.IStatsCallback {
    void onStatsLoaded(java.lang.String);
    void onStatsError(int, java.lang.String);
}

-keepclassmembers interface com.bizsim.google.play.games.events.IEventsCallback {
...
-dontwarn com.bizsim.google.play.games.**
