...
namespace BizSim.Google.Play.Games.Editor
{
    ...
    public class GamesServicesAbout : EditorWindow
    {
        ...
        private const string PACKAGE_JSON_PATH = "Packages/com.bizsim.google.play.games/package.json";
        ...
        private void DrawPackageInfo()
        {
            ...
            DrawInfoRow("Name:", "com.bizsim.google.play.games");
        ...
        private void DrawDependencies()
        {
            ...
            EditorGUILayout.HelpBox(
                "External Dependencies (resolved at Android build time):\n" +
                "• com.google.android.gms:play-services-games-v2:21.0.0\n" +
                "• androidx.activity:activity:1.13.0\n" +
                "• com.google.android.gms:play-services-tasks (transitive)",
                MessageType.Info);
